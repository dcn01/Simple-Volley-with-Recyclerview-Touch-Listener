package com.hakiki95.simpelvolleyrequest.Helper;
...
public class RecyclerOnTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerOnTouchListener(Context context, final RecyclerView recyclerView, final RecyclerClickListener clickListener)
    {
